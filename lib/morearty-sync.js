...
(function() {
  var B, Binding, History, Imm, Morearty, MoreartySync, SyncCollection, SyncModel, defaultSync, isEmptyObject, methodMap, validateModel,
  ...
  B.sync = function(method, model, options) {
    ...
    if (model instanceof SyncModel) {
      ...
      return xhr.success(function() {
        ...
        return model.updateStatus(null);
      });
    }
  };
  ...
  SyncModel = (function(_super) {
    ...
    function SyncModel(data, options) {
      ...
      this.binding = data instanceof Binding ? data : (options.parse ? data = this.parse(data, options) || {} : void 0, Binding.init(Imm.fromJS(data)));
    ...
    SyncModel.prototype.updateStatus = function(method) {
      if (this.options.xhrStatus) {
        if (method) {
          return this.set('status', methodMap[method]);
        } else {
          return this.unsetIfExists('status');
        }
      }
    };
