...
(function() {
  ...
  SyncCollection = (function(_super) {
    ...
    SyncCollection.prototype.get = function(id) {
      var item;
      item = this.binding.get().find(function(x) {
        return x.get('id') === id;
      });
      if (item) {
